    ...
    <div className="flex flex-col gap-4">
        <div className="flex gap-3 items-center">
            ...
            <div className="px-3 w-72 py-1.5 border border-white/10 rounded-lg flex items-center gap-3">
                ...
                value={search} className="bg-transparent flex-1 outline-none border-0  p-0 text-sm focus:ring-0" placeholder="Buscar participantes..." />
                {search}
            </div>
        </div>
                    ...
                    {attendees.map((attendee) => {
                        ...
                        <TableRow key={attendee.id} className="border-b border-white/10 hover:bg-white/5">
                            ...
                            <TableCell>
                                ...
                                null ? <span className="text-zinc-400">Não fez check-in</span>
